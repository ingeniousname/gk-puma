...
cbuffer mirrorBuf : register(b3) //Vertex Shader constant buffer slot 3
{
    float4 mirrorPoint;
    float4 mirrorNormal;
};
...
PSInput main(VSInput i)
{
    ...
    float3 mirrorToPoint = o.worldPos - mirrorPoint.xyz;
    o.clipDist = dot(mirrorToPoint, mirrorNormal.xyz);
